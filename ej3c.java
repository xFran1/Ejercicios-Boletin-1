public class ej3c {
    public static void main(String[] args) {
        Empresa factura = new Empresa(1, 5, 0.6);
        Empresa factura1 = new Empresa(2, 6, 3);
        Empresa factura2 = new Empresa(3, 200, 1.25);
...
class Empresa {
    ...
    public void cantidad_vendida_en_litros() {
        System.out.println("La cantidad vendida en litros del id " + this.id_articulo + " es: "
                + this.cantidad_vendida * this.precio_litro);
    }
